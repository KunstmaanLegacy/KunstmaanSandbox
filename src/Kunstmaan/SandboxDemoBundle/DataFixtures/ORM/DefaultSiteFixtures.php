...
namespace Kunstmaan\SandboxDemoBundle\DataFixtures\ORM;
...
class DefaultSiteFixtures extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    {
        $homepage = $this->createAndPersistPage($manager, 'Kunstmaan\SandboxDemoBundle\Entity\Pages\HomePage', $title, null, "", "homepage");
        {
    ...
    {
        return $this->createAndPersistPage($manager, 'Kunstmaan\SandboxDemoBundle\Entity\Pages\ContentPage', $title, $parent);
    }
    ...
    {
        $page = $this->createAndPersistPage($manager, 'Kunstmaan\SandboxDemoBundle\Entity\Pages\FormPage', $title, $parent);
    ...
    public function createMedia(ObjectManager $manager)
    {
        // Create dummy image folder and add dummy images
        {
            ...
            $path = $this->rootDir . '/../src/Kunstmaan/SandboxDemoBundle/Resources/public/img/general/logo.png';
        ...
        // Create dummy file folder and add dummy files
        {
            ...
            $path = $this->rootDir . '/../src/Kunstmaan/SandboxDemoBundle/Resources/public/files/dummy/sample.pdf';
