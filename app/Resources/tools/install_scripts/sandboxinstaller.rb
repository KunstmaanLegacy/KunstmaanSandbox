...
if command == "install-bundles"
    ...
    requires["kunstmaan/article-bundle"] =  "dev-master@dev"
    requires["kunstmaan/behat-bundle"] =  "dev-master@dev"
    ...
    required["kunstmaan/node-search-bundle"] = "dev-master"
    requires["kunstmaan/pagepart-bundle"] =  "2.2.*@dev"
    requires["kunstmaan/search-bundle"] = "dev-master@dev"
    requires["kunstmaan/sentry-bundle"] =  "2.2.*@dev"
    requires["kunstmaan/seo-bundle"] =  "2.2.*@dev"
    requires["kunstmaan/sitemap-bundle"] = "dev-master@dev"
